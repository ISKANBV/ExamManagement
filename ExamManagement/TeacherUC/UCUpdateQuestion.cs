...
{
    public partial class UCUpdateQuestion : UserControl
    {
        Function fn = new Function();
        String query;


        public UCUpdateQuestion()
        {
            InitializeComponent();
        }

        private void UCUpdateQuestion_Load(object sender, EventArgs e)
        {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if(comboQuestion.SelectedIndex != -1)
            {
                ...
                query = "update questions set question = '" + question + "',optionA = '" + option1 + "'," +
                    "optionB = '" + option2 + "',optionC = '" + option3 + "'," +
                    "optionD = '" + option4 + "',ans = '"+ans+"'" +
        ...
        {
            UCUpdateQuestion_Load(this, null);
        }
    }
}
